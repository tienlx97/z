    ...
    <>
      ...
      <section className="my-8 sm:my-10 grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-4">
        <div className="flex flex-col justify-center">
          <YouWillLearnCard title="Blog" path="/blog">
            <p>My blog about IT such as frontend, backend or testing</p>
          </YouWillLearnCard>
        </div>
        <div className="flex flex-col justify-center">
          <YouWillLearnCard title="Japanese Progress" path="/japan/react">
            <p>Mastering japanese from zero to hero with my progress</p>
          </YouWillLearnCard>
        </div>
      </section>
    </>
