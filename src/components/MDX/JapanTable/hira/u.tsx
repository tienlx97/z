...
export default function svgComp() {
  return (
    <svg
      ...
      <path
        id="z12358d1"
        d="M406 101C399 101 389 103 388 111C390 121 400 124 406 130C444 155 485 176 527 193C562 207 598 219 635 228C650 229 668 224 674 209C680 192 669 174 656 164C640 150 619 142 597 142C544 136 491 125 439 108C429 104 418 101 406 101Z"
      />
      <path
        id="z12358d2"
        d="M581 343C514 344 450 367 386 385C345 398 304 415 261 416C243 415 226 410 208 411C199 414 200 426 206 431C224 453 248 472 277 475C299 478 321 470 341 460C373 443 406 427 440 416C490 397 543 383 597 381C619 382 642 391 655 410C673 436 672 469 671 500C667 576 640 650 604 717C572 778 532 834 492 890C485 898 476 907 478 919C482 928 495 927 502 922C513 913 521 901 531 892C602 818 666 737 710 644C734 595 751 540 747 485C743 443 726 400 693 372C662 347 620 342 581 343Z"
      />
      <defs>
        <clipPath id="z12358c1">
          <use xlinkHref="#z12358d1" />
        </clipPath>
        <clipPath id="z12358c2">
          <use xlinkHref="#z12358d2" />
        </clipPath>
      </defs>
      <path
        style={{'--d': '1s'} as any}
