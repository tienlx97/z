...
export default function svgComp() {
  return (
    <svg
      ...
      <path
        id="z12503d2"
        d="M905 24C865 27 826 55 815 95C802 136 820 185 858 207C891 227 935 224 967 203C988 190 1000 167 1005 144C1012 114 1005 80 983 58C965 37 938 24 909 24C908 24 907 23 905 24ZM908 69C930 68 955 82 961 105C967 126 962 152 943 166C916 185 874 176 860 146C854 131 856 114 861 100C868 81 887 68 908 69C906 39 906 39 905 24Z"
      />
      <defs>
        <clipPath id="z12503c1">
          <use xlinkHref="#z12503d1" />
        </clipPath>
        <clipPath id="z12503c2">
          <use xlinkHref="#z12503d2" />
        </clipPath>
      </defs>
      <path
        style={{'--d': '1s'} as any}
