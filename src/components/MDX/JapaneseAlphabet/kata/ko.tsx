...
export default function svgComp() {
  return (
    <svg
      ...
      <path
        id="z12467d2"
        d="M626 672C573 676 522 690 469 696C383 706 296 714 209 715C181 716 201 742 209 751C228 771 256 781 283 781C333 780 380 766 428 756C475 747 523 741 571 740C617 739 673 745 708 733C735 723 733 691 702 679C678 670 651 672 626 672Z"
      />
      <defs>
        <clipPath id="z12467c1">
          <use xlinkHref="#z12467d1" />
        </clipPath>
        <clipPath id="z12467c2">
          <use xlinkHref="#z12467d2" />
        </clipPath>
      </defs>
      <path
        style={{'--d': '1s'} as any}
        pathLength="3333"
        clipPath="url(#z12467c1)"
        d="M 212,320 689,298 762,343 673,664"
      />
      <path
        style={{'--d': '2s'} as any}
        pathLength="3333"
        clipPath="url(#z12467c2)"
        d="M 211,725 722,708.4"
      />
    </svg>
  );
}
