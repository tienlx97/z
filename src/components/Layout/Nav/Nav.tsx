...
import {useSBMobileContext} from 'context/SBMobile';
...
export default function Nav() {
  ...
  function selectTab(nextTab: 'blog' | 'japan') {
    setTab(nextTab);
    ...
    <div
      ...
      <nav className="items-center w-full flex lg:block justify-between bg-wash dark:bg-wash-dark pt-0 lg:pt-4 pr-5 lg:px-5 z-50">
        ...
        <div className="px-0 pt-2 w-full 2xl:max-w-xs hidden lg:flex items-center self-center border-b-0 lg:border-b border-border dark:border-border-dark">
          <NavLink
            href="/blog"
            isActive={section === 'blog' || section === 'home'}>
            Blog
          </NavLink>
          <NavLink href="/japan" isActive={section === 'japan'}>
            Japan
          </NavLink>
        </div>
      ...
      {isOpen && (
        <div className="bg-wash dark:bg-wash-dark px-5 flex justify-end border-b border-border dark:border-border-dark items-center self-center w-full z-10">
          <TabButton
            isActive={tab === 'blog' || tab === 'home'}
            onClick={() => selectTab('blog')}>
            Blog
          </TabButton>
          <TabButton
            isActive={tab === 'japan'}
            onClick={() => selectTab('japan')}>
            Japan
          </TabButton>
        </div>
      )}
      ...
      <div
        ...
        <aside
          ...
          {!isOpen && (
            <div className="px-5 sm:pt-10 lg:pt-4">{/* <Search /> */}</div>
          )}
          <nav
            role="navigation"
